...
const form = useForm({
    ...
    image: null,
    _method: "PUT",
    //if inertia form has a file, you have to use post and specify the method in the form definition
})
</script>

<template>
    <Head title="- Edit Listing"></Head>
      <Container>
          <div class="mb-6">
              <Title>Edit your listing here:</Title>
          </div>
          ...
          <div class="space-y-6">
              ...
              <div class="space-y-6">
                ...
                <div>  <PrimaryBtn :disabled="form.processing" >Update</PrimaryBtn></div>
          </form>

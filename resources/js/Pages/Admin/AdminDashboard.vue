...
<template>
    ...
    <!-- Heading -->
    <div class="flex flex-end justify-between mb-4">
...
<!--        Toggle role btn-->
        <div class="flex items-center gap-1 text-xs hover:bg-slate-300
            ...
            <input
                ...
                type="checkbox"
                id="toggleRole"
                class="rounded-md border-1 outline-0 text-indigo-500 ring-indigo-500
                border-slate-700 cursor-pointer">
            <label for="toggleRole"
                    class="block p-1 text-sm font-medium text-slate-700
